...
class CursoForm(FlaskForm):
    nombre = StringField('Nombre Curso', validators=[DataRequired(), Length(max=128)])
    profesor = StringField('Profesor', validators=[DataRequired()])
    submit = SubmitField('Enviar')

class SalonForm(FlaskForm):
    nombre = StringField('Nombre Salon', validators=[DataRequired(), Length(max=128)])
    periodo = StringField('Periodo', validators=[DataRequired()])
    alumno = StringField('Alumno', validators=[DataRequired()])
    profesor = StringField('Profesor', validators=[DataRequired()])
    submit = SubmitField('Enviar')