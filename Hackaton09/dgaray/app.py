...
from forms import SignupForm, LoginForm, AlumnoForm, ProfesorForm, SalonForm, CursoForm
from models import users, get_user, User, Alumnos, Profesores
...
@login_required
def post_form3(id_salon):
    form = SalonForm()
    if form.validate_on_submit():
        nombre = form.nombre.data
        ano_escolar = form.ano_escolar.data

        salon = {'nombre': nombre, 'ano_escolar': ano_escolar}
