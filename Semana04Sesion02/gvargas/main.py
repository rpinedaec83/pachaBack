...
# os.makedirs("MiPrimeraCarpeta") crear carpeta
# #os.removedirs("MiPrimeraCarpeta") eliminar carpeta

# listaDirectorios = os.listdir('../..') la lista tendrá los niveles dependiendo de los puntos
